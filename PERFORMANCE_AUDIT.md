...
11. Continue core modules Wave 1 optimizations from `PERFORMANCE_AUDIT_CORE_MODULES_DEEP_DIVE.md` (symbology allocation trimming + bounded resolve memoization complete; remaining focus is validator hot-path optimization, quality timestamp/sort reductions, and middleware import hoist).
