...
11. Continue core modules Wave 1 optimizations from `PERFORMANCE_AUDIT_CORE_MODULES_DEEP_DIVE.md` (symbology allocation trimming + bounded resolve memoization and middleware import hoist complete; remaining focus is validator hot-path optimization and quality timestamp/sort reductions).
