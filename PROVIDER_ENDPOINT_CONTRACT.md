...
| `GET` | `/api/v1/uw/analytics/sliding` | `gateway/api/uw/congress_ext.py:get_sliding_window_analytics` |
| `GET` | `/api/v1/uw/analytics/window` | `gateway/api/uw/congress_ext.py:get_fixed_window_analytics` |
| `GET` | `/api/v1/uw/calendar/ipo` | `gateway/api/uw/fundamentals.py:get_ipo_calendar` |
| `GET` | `/api/v1/uw/commodities/{name}` | `gateway/api/uw/crossasset.py:get_commodity_series` |
| `GET` | `/api/v1/uw/companies/listings` | `gateway/api/uw/fundamentals.py:get_company_listings` |
| `GET` | `/api/v1/uw/companies/{symbol}/dividends` | `gateway/api/uw/fundamentals.py:get_company_dividends` |
| `GET` | `/api/v1/uw/companies/{symbol}/earnings-estimates` | `gateway/api/uw/fundamentals.py:get_earnings_estimates` |
| `GET` | `/api/v1/uw/companies/{symbol}/profile` | `gateway/api/uw/fundamentals.py:get_company_profile` |
| `GET` | `/api/v1/uw/companies/{symbol}/splits` | `gateway/api/uw/fundamentals.py:get_company_splits` |
| `GET` | `/api/v1/uw/companies/{symbol}/transcripts/{quarter}` | `gateway/api/uw/fundamentals.py:get_earnings_transcript` |
| `GET` | `/api/v1/uw/congress/congress-trader` | `gateway/api/uw/congress_ext.py:get_congress_trader_recent_reports` |
| `GET` | `/api/v1/uw/congress/late-reports` | `gateway/api/uw/extended.py:get_congress_late_reports` |
| `GET` | `/api/v1/uw/congress/politicians` | `gateway/api/uw/congress_ext.py:get_congress_politicians` |
...
| `GET` | `/api/v1/uw/congress/unusual-trades` | `gateway/api/uw/congress_ext.py:get_unusual_congress_trades` |
| `GET` | `/api/v1/uw/congress/unusual-trades/by-tickers` | `gateway/api/uw/congress_ext.py:get_unusual_congress_trades_by_tickers` |
| `GET` | `/api/v1/uw/congress/unusual-trades/chart-data` | `gateway/api/uw/congress_ext.py:get_unusual_congress_trades_chart_data` |
| `GET` | `/api/v1/uw/congress/unusual-trades/stats` | `gateway/api/uw/congress_ext.py:get_unusual_congress_trades_stats` |
...
| `GET` | `/api/v1/uw/crypto/whale-transactions` | `gateway/api/uw/crossasset.py:get_crypto_whale_transactions` |
| `GET` | `/api/v1/uw/crypto/whales/recent` | `gateway/api/uw/crossasset.py:get_recent_crypto_whale_trades` |
| `GET` | `/api/v1/uw/crypto/{pair}/ohlc/{candle_size}` | `gateway/api/uw/crossasset.py:get_crypto_ohlc_candles` |
| `GET` | `/api/v1/uw/crypto/{pair}/state` | `gateway/api/uw/crossasset.py:get_crypto_pair_state` |
...
| `GET` | `/api/v1/uw/digital-currencies/history` | `gateway/api/uw/crossasset.py:get_digital_currency_history` |
| `GET` | `/api/v1/uw/digital-currencies/intraday` | `gateway/api/uw/crossasset.py:get_digital_currency_intraday` |
...
| `GET` | `/api/v1/uw/economy/{indicator}` | `gateway/api/uw/crossasset.py:get_economic_indicator` |
...
| `GET` | `/api/v1/uw/forex/history` | `gateway/api/uw/crossasset.py:get_forex_history` |
| `GET` | `/api/v1/uw/forex/intraday` | `gateway/api/uw/crossasset.py:get_forex_intraday` |
| `GET` | `/api/v1/uw/forex/rate` | `gateway/api/uw/crossasset.py:get_forex_rate` |
...
| `GET` | `/api/v1/uw/group-flow/{flow_group}/greek-flow/{expiry}` | `gateway/api/uw/options_ext.py:get_group_flow_greek_flow_by_expiry` |
...
| `GET` | `/api/v1/uw/institution/{name}/activity/v2` | `gateway/api/uw/congress_ext.py:get_institution_activity_v2` |
...
| `GET` | `/api/v1/uw/lit-flow/recent` | `gateway/api/uw/options_ext.py:get_lit_flow_recent` |
| `GET` | `/api/v1/uw/lit-flow/{symbol}` | `gateway/api/uw/options_ext.py:get_ticker_lit_flow` |
...
| `GET` | `/api/v1/uw/market/movers` | `gateway/api/uw/options_ext.py:get_market_movers` |
| `GET` | `/api/v1/uw/market/net-flow-expiry` | `gateway/api/uw/flow_analytics.py:get_net_flow_expiry` |
| `GET` | `/api/v1/uw/market/oi-change` | `gateway/api/uw/options_ext.py:get_market_oi_change` |
...
| `GET` | `/api/v1/uw/option-trades/exchange-breakdown/{date}` | `gateway/api/uw/options_ext.py:get_option_trades_exchange_breakdown` |
| `GET` | `/api/v1/uw/option-trades/flow-alerts/{id}` | `gateway/api/uw/options_ext.py:get_flow_alert_by_id` |
| `GET` | `/api/v1/uw/option-trades/optionable-tickers` | `gateway/api/uw/options_ext.py:get_optionable_tickers` |
| `GET` | `/api/v1/uw/options-pulse/sectors` | `gateway/api/uw/options_ext.py:get_options_pulse_sectors` |
| `GET` | `/api/v1/uw/options-pulse/top` | `gateway/api/uw/options_ext.py:get_options_pulse_top` |
| `GET` | `/api/v1/uw/options-pulse/total` | `gateway/api/uw/options_ext.py:get_options_pulse_total` |
| `GET` | `/api/v1/uw/politician-portfolios/disclosures` | `gateway/api/uw/congress_ext.py:get_politician_disclosures` |
...
| `GET` | `/api/v1/uw/predictions/insiders` | `gateway/api/uw/predictions.py:get_prediction_insiders` |
| `GET` | `/api/v1/uw/predictions/market/{asset_id}` | `gateway/api/uw/predictions.py:get_prediction_market` |
| `GET` | `/api/v1/uw/predictions/market/{asset_id}/liquidity` | `gateway/api/uw/predictions.py:get_prediction_market_liquidity` |
| `GET` | `/api/v1/uw/predictions/market/{asset_id}/positions` | `gateway/api/uw/predictions.py:get_prediction_market_positions` |
| `GET` | `/api/v1/uw/predictions/search-users` | `gateway/api/uw/predictions.py:get_prediction_search_users` |
| `GET` | `/api/v1/uw/predictions/smart-money` | `gateway/api/uw/predictions.py:get_prediction_smart_money` |
| `GET` | `/api/v1/uw/predictions/unusual` | `gateway/api/uw/predictions.py:get_prediction_unusual_markets` |
| `GET` | `/api/v1/uw/predictions/user/{user_id}` | `gateway/api/uw/predictions.py:get_prediction_user` |
| `GET` | `/api/v1/uw/predictions/whales` | `gateway/api/uw/predictions.py:get_prediction_whales` |
| `GET` | `/api/v1/uw/private-markets/companies` | `gateway/api/uw/private_markets.py:get_private_markets_companies` |
| `GET` | `/api/v1/uw/private-markets/companies/{npm_ticker}` | `gateway/api/uw/private_markets.py:get_private_markets_company` |
| `GET` | `/api/v1/uw/private-markets/companies/{npm_ticker}/funding` | `gateway/api/uw/private_markets.py:get_private_markets_funding` |
| `GET` | `/api/v1/uw/private-markets/companies/{npm_ticker}/investors` | `gateway/api/uw/private_markets.py:get_private_markets_company_investors` |
| `GET` | `/api/v1/uw/private-markets/companies/{npm_ticker}/management` | `gateway/api/uw/private_markets.py:get_private_markets_management` |
| `GET` | `/api/v1/uw/private-markets/companies/{npm_ticker}/pricing` | `gateway/api/uw/private_markets.py:get_private_markets_pricing` |
| `GET` | `/api/v1/uw/private-markets/investors` | `gateway/api/uw/private_markets.py:get_top_private_markets_investors` |
| `GET` | `/api/v1/uw/private-markets/investors/{name}` | `gateway/api/uw/private_markets.py:get_private_markets_investor` |
| `GET` | `/api/v1/uw/private-markets/search` | `gateway/api/uw/private_markets.py:get_private_markets_search` |
...
| `GET` | `/api/v1/uw/short_screener` | `gateway/api/uw/congress_ext.py:get_short_screener` |
...
| `GET` | `/api/v1/uw/shorts/{symbol}/interest-float/v2` | `gateway/api/uw/congress_ext.py:get_short_interest_float_v2` |
| `GET` | `/api/v1/uw/shorts/{symbol}/volumes-by-exchange` | `gateway/api/uw/extended.py:get_short_volumes_by_exchange` |
| `GET` | `/api/v1/uw/stock-directory/ticker-exchanges` | `gateway/api/uw/fundamentals.py:get_ticker_exchanges` |
| `GET` | `/api/v1/uw/stock/{symbol}/atm-options` | `gateway/api/uw/stock.py:get_atm_option_contracts` |
| `GET` | `/api/v1/uw/stock/{symbol}/balance-sheets` | `gateway/api/uw/fundamentals.py:get_balance_sheets` |
| `GET` | `/api/v1/uw/stock/{symbol}/candles` | `gateway/api/uw/stock.py:get_stock_candles` |
| `GET` | `/api/v1/uw/stock/{symbol}/cash-flows` | `gateway/api/uw/fundamentals.py:get_cash_flows` |
| `GET` | `/api/v1/uw/stock/{symbol}/daily-expiry-breakdown` | `gateway/api/uw/stock.py:get_daily_expiry_breakdown` |
| `GET` | `/api/v1/uw/stock/{symbol}/earnings` | `gateway/api/uw/fundamentals.py:get_stock_earnings` |
| `GET` | `/api/v1/uw/stock/{symbol}/financials` | `gateway/api/uw/fundamentals.py:get_stock_financials` |
| `GET` | `/api/v1/uw/stock/{symbol}/flow-alerts` | `gateway/api/uw/options_ext.py:get_ticker_flow_alerts` |
| `GET` | `/api/v1/uw/stock/{symbol}/flow-per-expiry` | `gateway/api/uw/options_ext.py:get_ticker_flow_per_expiry` |
| `GET` | `/api/v1/uw/stock/{symbol}/flow-per-strike` | `gateway/api/uw/options_ext.py:get_ticker_flow_per_strike` |
...
| `GET` | `/api/v1/uw/stock/{symbol}/fundamental-breakdown` | `gateway/api/uw/fundamentals.py:get_fundamental_breakdown` |
| `GET` | `/api/v1/uw/stock/{symbol}/gex-levels` | `gateway/api/uw/options_ext.py:get_gex_levels` |
...
| `GET` | `/api/v1/uw/stock/{symbol}/income-statements` | `gateway/api/uw/fundamentals.py:get_income_statements` |
...
| `GET` | `/api/v1/uw/stock/{symbol}/options-pulse` | `gateway/api/uw/options_ext.py:get_ticker_options_pulse` |
| `GET` | `/api/v1/uw/stock/{symbol}/options-volume` | `gateway/api/uw/stock.py:get_options_volume` |
| `GET` | `/api/v1/uw/stock/{symbol}/ownership` | `gateway/api/uw/fundamentals.py:get_stock_ownership` |
...
| `GET` | `/api/v1/uw/stock/{symbol}/spot-exposures/expiry-strike` | `gateway/api/uw/options_ext.py:get_ticker_spot_exposures_expiry_strike` |
| `GET` | `/api/v1/uw/stock/{symbol}/state` | `gateway/api/uw/stock.py:get_stock_state` |
| `GET` | `/api/v1/uw/stock/{symbol}/technical-indicator/{function}` | `gateway/api/uw/fundamentals.py:get_technical_indicator` |
| `GET` | `/api/v1/uw/stock/{symbol}/volatility/anomaly` | `gateway/api/uw/volatility_ext.py:get_volatility_anomaly` |
| `GET` | `/api/v1/uw/stock/{symbol}/volatility/character` | `gateway/api/uw/volatility_ext.py:get_volatility_character` |
| `GET` | `/api/v1/uw/stock/{symbol}/volatility/stats` | `gateway/api/uw/volatility_ext.py:get_volatility_stats` |
| `GET` | `/api/v1/uw/stock/{symbol}/volatility/variance-risk-premium` | `gateway/api/uw/volatility_ext.py:get_variance_risk_premium` |
...
| `GET` | `/api/v1/uw/volatility/anomaly/top` | `gateway/api/uw/volatility_ext.py:get_top_volatility_anomalies` |
| `GET` | `/api/v1/uw/volatility/character/top` | `gateway/api/uw/volatility_ext.py:get_top_volatility_character` |
| `GET` | `/api/v1/uw/volatility/vix-term-structure` | `gateway/api/uw/volatility_ext.py:get_vix_term_structure` |
