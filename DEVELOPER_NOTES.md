...
- The `heber:events` topic literal appears in 9 places (main.py + pollers + backfill + middleware) on purpose — consolidation is deferred because every one of those files is bind-mounted into the running container (see `docs/FOLLOW_UPS.md`).
