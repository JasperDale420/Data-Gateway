...
3. **Alpaca routers**: Continue shared execution-helper consolidation to the remaining high-surface route module (`trading.py`) and evaluate additional safe-GET cache/dedupe opportunities beyond metadata endpoints.
