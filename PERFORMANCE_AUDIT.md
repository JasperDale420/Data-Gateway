...
7. Continue non-provider router follow-ups from `PERFORMANCE_AUDIT_NON_PROVIDER_ROUTERS_DEEP_DIVE.md` (fetcher binding guards, cache-hit-first parsing in news, bulk streaming downloads, and replay control-loop remediation are complete; remaining focus is metrics/list-scaling follow-ups).
