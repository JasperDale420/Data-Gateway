...
14. Complete BENCH Wave 2/3 from `PERFORMANCE_AUDIT_BENCHMARKING_DEEP_DIVE.md` (add replay/bulk memory perf coverage, implement bounded sink in-flight dispatch, and add CI perf threshold/artifact enforcement).
