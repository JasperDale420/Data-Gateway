...
3. **Alpaca routers**: Route-helper consolidation is complete; continue with selective safe-GET cache/dedupe expansion where payload shape and staleness bounds are clear (for example, low-churn metadata-style reads).
