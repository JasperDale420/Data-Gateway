...
**Per-Symbol Quality Endpoint:**

```
GET /api/v1/quality/symbol/AAPL?date=2024-01-15
```
...
```json
{
  ...
  "quality": {
    "bars": {
      ...
      "coverage": 0.995,
      "gaps": [
        {"start": "12:30:00", "end": "12:32:00", "missing": 2}
      ]
    },
    "quotes": {
      "total": 125000,
