...
14. Tune BENCH guardrails from `PERFORMANCE_AUDIT_BENCHMARKING_DEEP_DIVE.md` (ratchet suite/per-test budgets from baseline history, expand slower-backend sink coverage, and add trend-delta regression checks).
