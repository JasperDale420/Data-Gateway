...
5. **Non-provider routers**: Continue route-level cache telemetry rollout to remaining helper surfaces (Finnhub news + quote/bars + mutual-funds + analysis + forex + crypto + alternative-data + earnings + ETF/index endpoints completed on 2026-02-08).
