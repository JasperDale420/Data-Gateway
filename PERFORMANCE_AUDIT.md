...
14. Tune BENCH guardrails from `PERFORMANCE_AUDIT_BENCHMARKING_DEEP_DIVE.md` (ratchet thresholds from baseline history, expand multi-sink bounded-backpressure coverage, and evolve per-test budget checks).
