...
3. **Alpaca routers**: Continue shared execution-helper consolidation to remaining route modules (`crypto.py`, `news.py`, `screener.py`, `trading.py`, `watchlists.py`) and evaluate additional safe-GET cache/dedupe opportunities beyond metadata endpoints.
