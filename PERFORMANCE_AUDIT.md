...
6. Implement Alpaca Wave 1 optimizations from `PERFORMANCE_AUDIT_ALPACA_DEEP_DIVE.md` (option-chain snapshot + stock-trades over-fetch reductions and stock snapshot concurrency are complete; remaining focus is route helper consolidation and cache/dedupe for safe GETs).
