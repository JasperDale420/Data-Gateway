...
7. Continue non-provider router follow-ups from `PERFORMANCE_AUDIT_NON_PROVIDER_ROUTERS_DEEP_DIVE.md` (fetcher binding guards, cache-hit-first parsing in news, and bulk streaming downloads are complete; remaining focus is replay control-loop and metrics/list-scaling follow-ups).
