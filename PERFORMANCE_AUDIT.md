...
11. Continue core modules follow-ups from `PERFORMANCE_AUDIT_CORE_MODULES_DEEP_DIVE.md` (Wave CORE-1 validator hot-path optimization, symbology allocation trimming, quality timestamp/sort reductions, and middleware import hoist are complete; calendar span guardrails are now complete; remaining focus is Wave CORE-2 quality single-pass consolidation and script follow-ups).
