...
1. Continue UW Wave 1 rollout from `PERFORMANCE_AUDIT_UW_DEEP_DIVE.md` (shared helper now in `flow.py`, `market.py`, and `stock.py`; apply to remaining UW routers and finish provider accessor dedupe).
